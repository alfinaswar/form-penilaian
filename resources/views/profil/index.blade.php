            ...
            <div class="card-body d-flex">
                ...
                <div class="clearfix d-xl-flex flex-grow-1">
                    <div class="clearfix pe-md-5">
                        <h3 class="fw-semibold mb-1">{{ $sekolah->nama_sekolah ?? 'SMA Negeri 1 Jakarta' }} <img
                                src="images/verified-badge.png" alt="Verified"></h3>
                        <ul class="d-flex flex-wrap fs-6 align-items-center">
                            <li class="me-3 d-inline-flex align-items-center"><i
                                    class="las la-graduation-cap me-1 fs-18"></i>{{ $sekolah->jenjang ?? 'SMA' }}</li>
                            <li class="me-3 d-inline-flex align-items-center"><i
                                    class="las la-map-marker me-1 fs-18"></i>{{ $sekolah->alamat_sekolah ?? 'Jl. Pendidikan No. 123' }},
                                {{ $sekolah->kota ?? 'Jakarta' }}
                            </li>
                            <li class="me-3 d-inline-flex align-items-center"><i
                                    class="las la-envelope me-1 fs-18"></i>{{ $sekolah->email_sekolah ?? 'info@sman1jakarta.sch.id' }}
                            </li>
                        </ul>
                        <div class="d-md-flex d-none flex-wrap">
                            ...
                            <div class="border outline-dashed rounded p-2 d-flex align-items-center me-3 mt-3">
                                <div
                                    ...
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                                            d="M19 14C20.49 12.54 22 10.79 22 8.5C22 7.04131 21.4205 5.64236 20.3891 4.61091C19.3576 3.57946 17.9587 3 16.5 3C15.74 3 15.04 3.16 14.38 3.46L12 5.5L9.62 3.46C8.96 3.16 8.26 3 7.5 3C6.04131 3 4.64236 3.57946 3.61091 4.61091C2.57946 5.64236 2 7.04131 2 8.5C2 10.79 3.51 12.54 5 14L12 21L19 14Z"
                                            stroke="var(--bs-success)" stroke-width="2" stroke-linecap="round"
                                            stroke-linejoin="round" />
                                    </svg>
                                </div>
                                <div class="clearfix ms-2">
                            ...
                            <div class="border outline-dashed rounded p-2 d-flex align-items-center me-3 mt-3">
                                <div
                                    ...
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path d="M12 2L3 7L12 12L21 7L12 2Z" stroke="var(--bs-warning)" stroke-width="2"
                                            stroke-linecap="round" stroke-linejoin="round" />
                                        <path d="M3 17L12 22L21 17" stroke="var(--bs-warning)" stroke-width="2"
                                            stroke-linecap="round" stroke-linejoin="round" />
                                        <path d="M3 12L12 17L21 12" stroke="var(--bs-warning)" stroke-width="2"
                                            stroke-linecap="round" stroke-linejoin="round" />
                                    </svg>
                                </div>
                                <div class="clearfix ms-2">
                    ...
                    <div class="clearfix mt-3 mt-xl-0 ms-auto d-flex flex-column col-xl-3">
                        <div class="clearfix mb-3 text-xl-end">
                            <a href="javascript:void(0);" class="btn btn-primary ms-2">Download Form Penilaian</a>
                        </div>
                ...
                <div class="col-xl-6">
                    <div class="card">
                        <div class="card-header py-3">
                            ...
                            <a href="{{ route('profil.edit', $sekolah->id) }}" class="btn btn-sm btn-primary">Edit
                                Profil</a>
                        </div>
                        <div class="card-body">
                            <div class="row py-2">
                                ...
                                <div class="col-7">
                                    <span
                                        class="fs-13 fw-semibold">{{ $sekolah->nama_sekolah ?? 'SMA Negeri 1 Jakarta' }}</span>
                                </div>
                            </div>
                            <div class="row py-2">
                                <div class="col-5">
                            ...
                            <div class="row py-2">
                                ...
                                <div class="col-7">
                                    <span
                                        class="fs-13 fw-semibold">{{ $sekolah->jenjang ?? 'Sekolah Menengah Atas (SMA)' }}</span>
                                </div>
                            </div>
                            <div class="row py-2">
                                <div class="col-5">
                            ...
                            <div class="row py-2">
                                ...
                                <div class="col-7">
                                    <span
                                        class="fs-13 fw-semibold">{{ $sekolah->telepon_sekolah ?? '(021) 123-4567' }}</span>
                                </div>
                            </div>
                            <div class="row py-2">
                                <div class="col-5">
                                ...
                                <div class="col-7">
                                    <span
                                        class="fs-13 fw-semibold">{{ $sekolah->email_sekolah ?? 'info@sman1jakarta.sch.id' }}</span>
                                </div>
                            </div>
                            <div class="row py-2">
                                <div class="col-5">
                                ...
                                <div class="col-7">
                                    <a href="{{ $sekolah->website_sekolah ?? 'https://sman1jakarta.sch.id' }}"
                                        class="fs-13 fw-semibold text-primary"
                                        target="_blank">{{ $sekolah->website_sekolah ?? 'sman1jakarta.sch.id' }}</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row py-2">
                                ...
                                <div class="col-8">
                                    <span
                                        class="fs-13 fw-semibold">{{ $sekolah->alamat_sekolah ?? 'Jl. Pendidikan Raya No. 123' }}</span>
                                </div>
                            </div>
                            <div class="row py-2">
                                <div class="col-4">
                        ...
                        <div class="card-body">
                            <div
                                ...
                                <div class="mx-3">
                                    ...
                                    <p class="mb-0 fs-13">Data sekolah telah diverifikasi oleh Kemendikbudristek. NPSN aktif
                                        dan terdaftar resmi.</p>
                                </div>
                            </div>
                        </div>
                    </div>
